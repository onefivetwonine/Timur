...
Human Talent Decision Intelligence. This repository is the starting engineering
foundation for Talent V0.1, with separate **POC** and **production** infrastructure
configurations and one shared TypeScript codebase.

The foundation includes runnable health/status services, shared schema validation,
tenant-scoped database infrastructure, Azure Terraform, CI and recovery runbooks.
It is not yet a recruitment product or an accepted production service. No cloud
resources have been deployed. POC and production both default to synthetic data;
external AI and recruitment actions are disabled.
...
- [Architecture and source authority](docs/architecture/baseline.md)
- [Environment configuration](config/README.md)
- [Azure infrastructure and state setup](infra/README.md)
- [Backup and disaster recovery](docs/operations/backup-and-recovery.md)
- [Implementation roadmap](docs/plans/implementation-roadmap.md)
- [Production launch checklist](docs/operations/launch-checklist.md)
- [Verification record](docs/reference/verification.md)
